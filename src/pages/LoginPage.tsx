      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="card p-6 sm:p-8">
          ...
          <div className="space-y-2.5">
            ...
            <button onClick={signInWithGitHub} disabled={!configured}
              className="btn btn-lg btn-block"
          ...
          <form onSubmit={submit} className="space-y-3">
            ...
            <label className="block">
              ...
              <div className="relative">
                ...
                <input className="input" style={{ paddingLeft: 36 }} type="password" value={password} onChange={e => setPassword(e.target.value)}
        ...
        <p className="hint text-center mt-6 flex items-center justify-center gap-1.5"><Icon name="lock" size={13} /> Login aman &amp; data tersimpan langsung di database</p>
      </div>
    </div>
  )
}
